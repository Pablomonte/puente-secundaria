...
## Página 108. Explico un proceso
**Texto**  
En Ciencias muchas veces hay que explicar un proceso: cómo ocurre un cambio, cómo se produce un fenómeno o cómo se relacionan varias partes.

**Sugerencias**

- escribir en orden
- usar conectores como primero, luego, después, finalmente
- nombrar con precisión lo que ocurre

**Actividad**
Explicá el ciclo del agua en 4 pasos.

Podés usar estas palabras:
- evaporación
- condensación
- nubes
- lluvia
...
## Página 109. Del cuadro o gráfico a la explicación escrita
**Texto**  
No alcanza con mirar los datos. También hay que transformarlos en una explicación escrita.

**Actividad**
Volvé a los datos de altura de la planta y escribí:
- una oración que diga qué muestra
- una oración que compare datos
- una oración final que saque una conclusión

**Consigna de revisión**
Revisá si tu explicación:
- se apoya en los datos
- usa vocabulario claro
- no repite siempre las mismas palabras

## Página 110. Mini práctica integradora
**Sección 1**
Usá la tabla de temperatura del agua y escribí:
- el tema
- dos datos importantes

**Sección 2**
Completá un cuadro comparativo simple entre tiempo atmosférico y clima.

**Sección 3**
Explicá el ciclo del agua en orden, usando conectores.

**Sección 4**
Escribí una explicación breve a partir de los datos de altura de la planta.

**Sección 5. Autoevaluación**

- Puedo leer mejor tablas y gráficos.
- Puedo comparar datos.
- Puedo explicar un proceso en orden.
- Puedo escribir una explicación apoyándome en información visual.
