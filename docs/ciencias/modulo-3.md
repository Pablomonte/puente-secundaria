...
## Página 114. Conclusiones más fundamentadas
**Texto**  
Una conclusión en Ciencias es más fuerte cuando se apoya en datos, observaciones o resultados, y no solo en opiniones.

**Ejemplo**
Conclusión débil:  
La planta estaba mejor.

Conclusión más fundamentada:  
La planta que recibió más luz creció más, porque aumentó su altura y sus hojas se mantuvieron verdes durante toda la observación.

**Actividad**
Mejorá estas conclusiones:
- salió bien
- cambió mucho
- fue mejor
- pasó porque sí

## Página 115. Escribo una conclusión completa
**Sugerencias**
Una conclusión puede incluir:
- qué se observó
- qué cambió o qué relación apareció
- qué se puede afirmar a partir de los datos

**Actividad**
A partir de la tabla de las dos plantas, escribí una conclusión de 3 o 4 oraciones.

**Lista de revisión**

- ¿Mi conclusión se basa en datos?
- ¿Evita frases vagas?
- ¿Explica algo, no solo lo nombra?
- ¿Tiene sentido con la hipótesis y con lo observado?

## Página 116. Mini práctica integradora
**Sección 1**
Escribí una hipótesis para esta situación:
“Dos recipientes con agua se dejan al sol y a la sombra durante una hora.”

**Sección 2**
En la experiencia de las dos plantas, identificá:
- qué cambia
- qué se mantiene
- qué se observa

**Sección 3**
Compará tu hipótesis sobre los recipientes con este resultado:
“El recipiente que quedó al sol terminó con agua más tibia.”

**Sección 4**
Redactá una conclusión breve y fundamentada sobre la experiencia de las dos plantas.

**Sección 5. Autoevaluación**

- Puedo formular una hipótesis simple.
- Puedo reconocer qué cambia y qué se mantiene.
- Puedo comparar lo esperado con lo observado.
- Puedo escribir conclusiones más claras.
